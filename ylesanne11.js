...
const nimed = [
  ...
  const inimesteAndmed = [
    ...
    // Lisa oma andmed siia kontrollimiseks
  ];
  ...
  // Kuvage sünniaeg ja vanus inimeste andmete põhjal
